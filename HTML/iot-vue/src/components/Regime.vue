<template>
  <div class="Regime">
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <b-form-group id="input-group-2" label="Seuil Luminosité:" label-for="input-2" description="En lumins">
        <b-form-input
          id="input-2"
      ...
      <b-form-group id="input-group-3" label="Durée de mise en veille:" label-for="input-3" description="En secondes">
        <b-form-input
          id="input-3"
      ...
      <b-form-group id="input-group-4" label="Début du régime (heure et minute):" label-for="input-4">
        <b-form-input
          id="input-3"
  ...
  name: 'Regime',
    ...
    methods: {
      onSubmit(evt) {
        ...
        this.$axios.post('http://localhost:3000/sendRegime', this.form
        ).then(response => {
